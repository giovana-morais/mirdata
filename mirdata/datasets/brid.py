"""
    BRID: The Brazilian Rhythmic Instruments Dataset for computational rhythm
...
.. admonition:: Dataset Info
    ...
    Annotations include beats, downbeats and rhythmic patterns.

    The dataset contains only short tracks around 30 seconds on average,
    totaling 2hrs 57 min (1.09 GB of data).

    This dataset was created and made public by the STAREL project
    (https://www02.smt.ufrj.br/~starel/index.html).

    274 solo and 93 multiple-instrument recorded tracks of 10 different
    instrument classes with variarions (e.g., material, size, stick) playing in
    5 main rhythm classes (samba, partido alto, samba-enredo, capoeira, and
    marcha).

    The dataset can be accessed and downloaded through the following link:
    https://drive.google.com/drive/folders/13DOFgbbrehQLYLplASYc_YC1knyHulBv
"""
import csv
import json
import os
...
BIBTEX = """
    @inproceedings{maia2018brid,
        author = {L.S. Maia and P. D. de Tomaz Jr. and
            M. Fuentes and M. Rocamora and L. W. P. Biscainho and
            M. V. M. da Costa and S. Cohen},
        title = {A Novel Database of Brazilian Rhythmic Instruments and Some
    Experiments in Computational Rhythm Analysis},
        booktitle = {2018 Audio Engineering Society Latin American Conference},
        year = {2018},
        pages = {},
...
INDEXES = {
    "default": "1.0",
    "test": "1.0",
    "1.0": core.Index(filename="brid_index_1.0.json"),
...
REMOTES = {
    "acoustic_mixtures": download_utils.RemoteFileMetadata(
        filename="acoustic_mixtures.zip",
        url="https://drive.google.com/drive/folders/1w1fRP7L9g8o3THu3zRuHRspuljQiIJ79",
    ...
    # "solo_tracks": (
    #     filename="solo_tracks.zip",
    #     url="https://drive.google.com/drive/folders/1jxsiez7gXcYphmJKHF_qXBWrtmGALkbO",
    #     checksum="",
    #     destination_dir="",
    # )
}
